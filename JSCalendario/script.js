...
let tabla = '<ul class="' + 'mes' + '">';
let contadorFinesDeSemana = 1;
let semana = [
    'L', 'M', 'X', 'J', 'V', 'S', 'D'
];
let meses = [
...
for (let indiceMeses = 0; indiceMeses < meses.length; indiceMeses++) {
    ...
    contadorFinesDeSemana = 1;
    tabla += " <li>" + meses[indiceMeses] + "</li>";

    for (let indiceBlanco = 0; indiceBlanco < 13; indiceBlanco++) {
    ...
    for (let index = 0; index < 32; index++) {
        ...
        if (index == 0) {
            for (let indice = 0; indice < semana.length; indice++) {
                tabla += " <li>" + "<strong>" + semana[indice] + "</strong>" + "</li>";

            }

        } else if (index == 31) {
            tabla += " <li>" + index + "</li>";
            for (let indiceBlanco = 0; indiceBlanco < 18; indiceBlanco++) {
            ...
            if (contadorFinesDeSemana > 6) {

                if (contadorFinesDeSemana == 8) {

                    contadorFinesDeSemana = 1;

                }

                tabla += '<li class= "findesemana">' + index + "</li>";
        ...
        contadorFinesDeSemana = contadorFinesDeSemana + 1;
    }
